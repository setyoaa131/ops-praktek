        ...
        <div class="content w-full" id="content">
            ...
            <form action="<?= base_url('update-produk/' . $produk['id_product']) ?>" method="post" enctype="multipart/form-data">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <?= csrf_field() ?>
                    <input type="hidden" name="id_product" id="id_product" value="<?= $produk['id_product'] ?>">
                    <div>
                        ...
                        <select name="kategori_produk" id="kategori_produk" class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                            <option value="" disabled <?= empty($produk['kategori_produk']) ? 'selected' : '' ?>>Pilih Kategori</option>
                            <option value="Alat Olahraga" <?= $produk['kategori_produk'] === 'Alat Olahraga' ? 'selected' : '' ?>>Alat Olahraga</option>
                            <option value="Alat Musik" <?= $produk['kategori_produk'] === 'Alat Musik' ? 'selected' : '' ?>>Alat Musik</option>
                        </select>
                    </div>
                    <div>
                ...
                <div class="mt-4">
                    ...
                    <div class="border-dashed border-2 border-blue-500 rounded-md p-4 flex flex-col items-center justify-center cursor-pointer"
                        ...
                        <img id="preview_image" src="<?= base_url('uploads/' . $produk['image']) ?>" alt="Upload Preview" class="mb-2 max-h-40" />
